Generated report at: /home/nicholas/uoa/sie699/traceability_report.md
ort is auto-generated by `scripts/traceability.py` to verify mapping completeness between Lean 4 implementations and Wayne Wymore's structured textbook definitions.
...
| `4.59/theorem/resultant_copy` | `theorem` | RSY(SCR) is a copy of RSY(SCR$). | ✅ Faithful | `cor4_59_resultant_copy` ([Mbse/CouplingIsomorphism.lean:499](Mbse/CouplingIsomorphism.lean#L499))<br>`cor4_59_resultant_copy` ([Mbse/TextbookExercises/Ch04.lean:376](Mbse/TextbookExercises/Ch04.lean#L376)) |
...
| `4.27/component/port_family` | `component` | The family SHIS = {HIi} (resp. SHOS = {HOj}) of per-port maps. | ✅ Faithful | `PreservesPorts.port` ([Mbse/Isomorphism.lean:314](Mbse/Isomorphism.lean#L314))<br>`swapPort` ([Mbse/TextbookExercises/Ch04.lean:235](Mbse/TextbookExercises/Ch04.lean#L235)) |
...
| Element ID | Type | Textbook Text | Status | Linked Lean Elements |
|------------|------|---------------|--------|----------------------|
| `4.47/definition/copy` | `definition` | A copy is a port-preserving isomorphism: an isomorphism whose input and output maps act coordinatewise on ports. | ✅ Faithful | `CopyWitness` ([Mbse/Isomorphism.lean:552](Mbse/Isomorphism.lean#L552))<br>`swap_isCopyOf_permuting` ([Mbse/TextbookExercises/Ch04.lean:284](Mbse/TextbookExercises/Ch04.lean#L284)) |
...
| `4.47/requirement/input_port_count` | `component` | #IPZ2 = #IPZ1: a bijection between the input port index types, which the copy may permute. | ✅ Faithful | `CopyWitness.inIdx` ([Mbse/Isomorphism.lean:563](Mbse/Isomorphism.lean#L563))<br>`swapPorts` ([Mbse/TextbookExercises/Ch04.lean:222](Mbse/TextbookExercises/Ch04.lean#L222)) |
...
| Element ID | Type | Textbook Text | Status | Linked Lean Elements |
|------------|------|---------------|--------|----------------------|
| `4.38/theorem/isomorphism_symmetric` | `theorem` | Z1 is isomorphic to Z2 iff Z2 is isomorphic to Z1, via the inverse isomorphisms. | ✅ Faithful | `isIsomorphicTo_symm` ([Mbse/Isomorphism.lean:272](Mbse/Isomorphism.lean#L272))<br>`isIsomorphicTo_comm` ([Mbse/Isomorphism.lean:282](Mbse/Isomorphism.lean#L282))<br>`thm4_38_isomorphism_symmetric` ([Mbse/TextbookExercises/Ch04.lean:45](Mbse/TextbookExercises/Ch04.lean#L45)) |
...
| `4.56/theorem/resultant_port_preserving_homomorphism` | `theorem` | RSY(SCR) is a port-preserving homomorphic image of RSY(SCR$). | ✅ Faithful | `thm4_56_resultant_homomorphic_image` ([Mbse/CouplingIsomorphism.lean:457](Mbse/CouplingIsomorphism.lean#L457))<br>`thm4_56_resultant_homomorphic_image` ([Mbse/TextbookExercises/Ch04.lean:366](Mbse/TextbookExercises/Ch04.lean#L366)) |
...
| `4.58/theorem/replacement_is_copy` | `theorem` | Z2 ∈ DSYSTEMS, OnZ2 = B, and Z2 is a copy of Z1. | ✅ Faithful | `replaceOutPort_isCopy` ([Mbse/IsomorphismConstructions.lean:134](Mbse/IsomorphismConstructions.lean#L134))<br>`thm4_58_replacement_is_copy` ([Mbse/TextbookExercises/Ch04.lean:300](Mbse/TextbookExercises/Ch04.lean#L300)) |
...
| `4.66/theorem/null_order_elimination` | `theorem` | There exists Z@$ in DSYSTEMS with Z@$ = RSY(SCR$) and Z@$ = HIMSY(Z@, PJN({SZ$ : Z$ in VSCR$}), ID(IZ@), ID(OZ@)). | ✅ Faithful | `ex4_66_null_order_elimination` ([Mbse/CouplingIsomorphism.lean:845](Mbse/CouplingIsomorphism.lean#L845))<br>`ex4_66_null_order_elimination` ([Mbse/TextbookExercises/Ch04.lean:397](Mbse/TextbookExercises/Ch04.lean#L397)) |
...
| `4.69/theorem/counterexample` | `theorem` | The one-state system is finite, the counter is not finite, and the one-state system is a homomorphic image of the counter. | ✅ Faithful | `ex4_69_counterexample` ([Mbse/IsomorphismConstructions.lean:183](Mbse/IsomorphismConstructions.lean#L183))<br>`ex4_69_counterexample` ([Mbse/TextbookExercises/Ch04.lean:312](Mbse/TextbookExercises/Ch04.lean#L312)) |
| `4.69/theorem/assertion_refuted` | `theorem` | The stated assertion does not hold. | ✅ Faithful | `ex4_69_assertion_false` ([Mbse/IsomorphismConstructions.lean:193](Mbse/IsomorphismConstructions.lean#L193))<br>`ex4_69_assertion_false` ([Mbse/TextbookExercises/Ch04.lean:318](Mbse/TextbookExercises/Ch04.lean#L318)) |
...
| `4.71/theorem/construction` | `theorem` | Z1 = HIMSY(Z2, PJN(SZ2,2), ID(IZ2), ID(OZ2)). | ✅ Faithful | `ex4_71_construction` ([Mbse/IsomorphismConstructions.lean:244](Mbse/IsomorphismConstructions.lean#L244))<br>`ex4_71_construction` ([Mbse/TextbookExercises/Ch04.lean:326](Mbse/TextbookExercises/Ch04.lean#L326)) |
...
| `4.74/theorem/consistent_elaboration` | `theorem` | Z2 ∈ DSYSTEMS, #SZ2 ≥ #SZ1, #IZ2 ≥ #IZ1, #OZ2 ≥ #OZ1 and Z1 = HIMSY(Z2, HS, HI, HO). | ✅ Faithful | `ex4_74_consistent_elaboration` ([Mbse/IsomorphismConstructions.lean:443](Mbse/IsomorphismConstructions.lean#L443))<br>`ex4_74_consistent_elaboration` ([Mbse/TextbookExercises/Ch04.lean:343](Mbse/TextbookExercises/Ch04.lean#L343)) |
...
| `4.80/theorem/preserves_input_ports` | `theorem` | HIMPPSY actually preserves input ports: the port index sets correspond bijectively and HI is the portwise product of surjections HIi. | ✅ Faithful | `IsPortPreservingHomImage` ([Mbse/Isomorphism.lean:459](Mbse/Isomorphism.lean#L459))<br>`ex4_80_preserves_input_ports` ([Mbse/TextbookExercises/Ch04.lean:82](Mbse/TextbookExercises/Ch04.lean#L82)) |
| `4.80/theorem/preserves_output_ports` | `theorem` | HIMPPSY actually preserves output ports: the port index sets correspond bijectively and HO is the portwise product of surjections HOj. | ✅ Faithful | `IsPortPreservingHomImage` ([Mbse/Isomorphism.lean:475](Mbse/Isomorphism.lean#L475))<br>`ex4_80_preserves_output_ports` ([Mbse/TextbookExercises/Ch04.lean:94](Mbse/TextbookExercises/Ch04.lean#L94)) |
...
| Element ID | Type | Textbook Text | Status | Linked Lean Elements |
|------------|------|---------------|--------|----------------------|
| `4.81/theorem/himppsy_reflexive_transitive` | `theorem` | HIMPPSY is reflexive (identity homomorphisms preserve every port) and transitive (coordinatewise maps compose coordinatewise). | ✅ Faithful | `isPortPreservingHomImage_refl` ([Mbse/Isomorphism.lean:524](Mbse/Isomorphism.lean#L524))<br>`isPortPreservingHomImage_trans` ([Mbse/Isomorphism.lean:534](Mbse/Isomorphism.lean#L534))<br>`ex4_81_reflexive` ([Mbse/TextbookExercises/Ch04.lean:106](Mbse/TextbookExercises/Ch04.lean#L106))<br>`ex4_81_transitive` ([Mbse/TextbookExercises/Ch04.lean:115](Mbse/TextbookExercises/Ch04.lean#L115)) |
...
| Element ID | Type | Textbook Text | Status | Linked Lean Elements |
|------------|------|---------------|--------|----------------------|
| `4.82/theorem/isomorphism_reflexive` | `theorem` | Every system is isomorphic to itself via the identity maps. | ✅ Faithful | `isIsomorphicTo_refl` ([Mbse/Isomorphism.lean:253](Mbse/Isomorphism.lean#L253))<br>`ex4_82_reflexive` ([Mbse/TextbookExercises/Ch04.lean:132](Mbse/TextbookExercises/Ch04.lean#L132)) |
| `4.82/theorem/isomorphism_transitive` | `theorem` | Composites of isomorphisms are isomorphisms. | ✅ Faithful | `isIsomorphicTo_trans` ([Mbse/Isomorphism.lean:261](Mbse/Isomorphism.lean#L261))<br>`ex4_82_transitive` ([Mbse/TextbookExercises/Ch04.lean:139](Mbse/TextbookExercises/Ch04.lean#L139)) |
| `4.82/theorem/isomorphism_symmetric` | `theorem` | Inverses of isomorphisms are isomorphisms. | ✅ Faithful | `isIsomorphicTo_symm` ([Mbse/Isomorphism.lean:272](Mbse/Isomorphism.lean#L272))<br>`ex4_82_symmetric` ([Mbse/TextbookExercises/Ch04.lean:149](Mbse/TextbookExercises/Ch04.lean#L149)) |
...
| Element ID | Type | Textbook Text | Status | Linked Lean Elements |
|------------|------|---------------|--------|----------------------|
| `4.84/theorem/copy_reflexive` | `theorem` | Every system is a copy of itself. | ✅ Faithful | `isCopyOf_refl` ([Mbse/Isomorphism.lean:677](Mbse/Isomorphism.lean#L677))<br>`ex4_84_reflexive` ([Mbse/TextbookExercises/Ch04.lean:160](Mbse/TextbookExercises/Ch04.lean#L160)) |
| `4.84/theorem/copy_transitive` | `theorem` | If Z1 is a copy of Z2 and Z2 is a copy of Z3, then Z1 is a copy of Z3. | ✅ Faithful | `isCopyOf_trans` ([Mbse/Isomorphism.lean:687](Mbse/Isomorphism.lean#L687))<br>`ex4_84_transitive` ([Mbse/TextbookExercises/Ch04.lean:169](Mbse/TextbookExercises/Ch04.lean#L169)) |
| `4.84/theorem/copy_symmetric` | `theorem` | If Z1 is a copy of Z2, then Z2 is a copy of Z1. | ✅ Faithful | `isCopyOf_symm` ([Mbse/Isomorphism.lean:702](Mbse/Isomorphism.lean#L702))<br>`ex4_84_symmetric` ([Mbse/TextbookExercises/Ch04.lean:184](Mbse/TextbookExercises/Ch04.lean#L184))<br>`swap_isCopyOf_symm` ([Mbse/TextbookExercises/Ch04.lean:294](Mbse/TextbookExercises/Ch04.lean#L294)) |
...
| `4.85/theorem/rearrangement_isomorphic` | `theorem` | RSY(SCR$) is isomorphic to RSY(SCR) via HS(x)i = x(F(i)) and the induced renamings on external ports. | ✅ Faithful | `ex4_85_rearrangement_isomorphic` ([Mbse/CouplingIsomorphism.lean:254](Mbse/CouplingIsomorphism.lean#L254))<br>`ex4_85_rearrangement_isomorphic` ([Mbse/TextbookExercises/Ch04.lean:389](Mbse/TextbookExercises/Ch04.lean#L389)) |

- Exercise kinds: **4** witness, **39** theorem-proof

## 3. Completeness & Quality Summary

- **Total Structured JSON Entries**: 141 (98 definitions/theorems, 43 exercises)
- **Definition/Theorem Elements**: 287 (285 faithful)
- **Exercise Task Elements**: 126 (126 faithful)
- **Total Individual Requirements/Elements**: 413
- **Linked Elements (any annotation)**: 411 (411/413)
- **Faithful Elements (excludes stub/partial)**: 411 (411/413)
