...
theorem zx9_after_reset (s0 : SZx9) (f : ITZ IZx9) (t : Time)
    (hf : f t = IZx9.v3) :
    generateStateTrajectory Zx9 s0 f (t + 1) = SZx9.v1 := by
  simp [generateStateTrajectory_succ, hf, zx9_reset]

/-- All three states are reachable from state v1. -/
theorem zx9_v1_reaches_all (s : SZx9) : Reachable Zx9 SZx9.v1 s := by
  cases s
  · -- v1: already there
