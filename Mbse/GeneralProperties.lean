...
structure SystemIdentityHomomorphicImageWitness {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ]
...
def SystemIsIdentityHomomorphicImage {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
...
theorem system_identityHom_iff_fsm {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
    {Z_spec Z_impl : DiscreteSystem SZ IZ OZ}
...
theorem system_extEqual_iff_identityHom {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
    {Z_spec Z_impl : DiscreteSystem SZ IZ OZ}
    (hSpec : AlwaysOutputs Z_spec) (hImpl : AlwaysOutputs Z_impl) :
...
theorem system_satisfies_implies_hom {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
...
theorem system_hom_implies_satisfies {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
    [Nonempty IZ] {Z_spec Z_impl : DiscreteSystem SZ IZ OZ}
    (hSpec : AlwaysOutputs Z_spec) (hImpl : AlwaysOutputs Z_impl)
...
theorem system_property_iff_hom {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
    [Nonempty IZ] {Z_spec Z_impl : DiscreteSystem SZ IZ OZ}
    (hSpec : AlwaysOutputs Z_spec) (hImpl : AlwaysOutputs Z_impl) :
...
theorem system_synthesized_property_iff_hom {SZ IZ OZ : Type} [Fintype SZ] [Fintype IZ] [Fintype OZ]
...
theorem fsm_property_iff_hom_via_embed {SZ IZ OZ : Type} [Nonempty IZ]
  ...
  haveI : Fintype SZ := F_spec.sz_finite
  haveI : Fintype IZ := F_spec.iz_finite
  haveI : Fintype OZ := F_spec.oz_finite
  simp only [PropertyFragment.General.SystemSatisfiesDynamics_iff_fsm]
